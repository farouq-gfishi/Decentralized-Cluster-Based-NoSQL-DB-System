...
public class AffinityNodeController {
    ...
    public ResponseEntity<String> addDocument(@PathVariable String documentName, @PathVariable String dbName, @RequestBody String documentContent) {
        return dataBaseCRUD.addDocument(documentName, dbName, documentContent);
    }

    @GetMapping("/get/{dbName}/{documentName}/{id}")
    public ResponseEntity<String> getDocumentById(@PathVariable String dbName, @PathVariable String documentName, @PathVariable String id) {
        return dataBaseCRUD.getDocumentById(dbName, documentName, id);
    }

    @GetMapping("/get-all/{dbName}/{documentName}")
    public ResponseEntity<String> getDocument(@PathVariable String dbName, @PathVariable String documentName) {
        return dataBaseCRUD.getDocument(dbName, documentName);
    }

    @PutMapping("/update/{dbName}/{documentName}/{id}")
    public ResponseEntity<String> updateDocumentById(@PathVariable String dbName, @PathVariable String documentName,
                                                     @PathVariable String id, @RequestBody String updatedContent) {
    ...
    public ResponseEntity<String> deleteDocument(@PathVariable String dbName, @PathVariable String documentName) {
        return dataBaseCRUD.deleteDocument(dbName, documentName);
    }

    @DeleteMapping("/delete/{dbName}/{documentName}/{id}")
    public ResponseEntity<String> deleteDocumentById(@PathVariable String dbName, @PathVariable String documentName, @PathVariable String id) {
